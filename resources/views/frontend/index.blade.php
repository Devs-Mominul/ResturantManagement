                    ...
                    <nav class="main-nav">
                        ...
                        -->
                            ...
                            <li class="scroll-to-section">
                                @auth
                                <a href="{{ route('cart.list',Auth::user()->id) }}">Cart({{ $count }})</a>
                                @else
                                <a href="#reservation">Contact(0) </a>
                                @endauth
                            </li>
                            <li>
                                @if (Route::has('login'))
        ...
        <div class="menu-item-carousel">
            <div class="col-lg-12">
                <div class="owl-menu-item owl-carousel">
                  ...
                  <form action="{{ url('/addtocarts',$food->id) }}" method="post">
                    @csrf
                  <div class="item">
                    <div class='card ' style="background-image: url('/upload/food/{{ $food->image }}')">
                ...
                <input type="number" name="quantity" id="" style="width: 80px" min="1" value="1">
                <input type="submit" value="Add to carts">
            </form>
